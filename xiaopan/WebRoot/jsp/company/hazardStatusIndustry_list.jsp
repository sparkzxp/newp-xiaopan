...
<title><s:property value='%{@com.iskyinfo.fw.ssi.common.ConfigReaderUtil@getPropertyValue("app.name.cn")}'/>_行业整改统计</title>
<base href="<%=basePath%>">
...
<body>
	<s:form action="cm_toHazardStatusList" namespace="/company"
		id="queryForm">
		<s:hidden name="clazzType" />
		<div class="content_title">行业整改统计</div>
		<!-- <div id="brDiv"></div> -->
