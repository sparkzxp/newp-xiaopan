            ...
            $(".delete").each(function(i) {
                $(this).click(function() {
                	if(confirm("确定删除吗？")){
						...
						$.post("<%=basePath%>sys/site_doDelete",{"site.id":aid},function(data){
		   					if(data=="success"){
		   						alert("操作成功！");
		   						location.reload();
		   					}else{
...
<body>
    ...
    <div class="top">
        ...
        <div class="t_content"><a href="<%=basePath%>jsp/admin/index.jsp">首页</a>>站点列表</div>
    ...
    <div class="content">
        <div class="c_l"></div>
        <div class="c_c">
            <div class="nav"><a href="<%=basePath%>sys/site_toEdit?site.id=">添加站点</a></div>
            <s:iterator value="sites" var="parent">
                <div class="list">
                    ...
                    <div class="list_r">
                        <a href="<%=basePath%>sys/site_toEdit?site.id=<s:property value="#parent.id" />">修改</a>|
