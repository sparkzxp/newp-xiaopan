            ...
            $(".delete").each(function(i) {
                $(this).click(function() {
                	if(confirm("确定删除吗？")){
						...
						$.post("<%=basePath%>sys/city_doDelete",{"city.id":aid},function(data){
		   					if(data=="success"){
		   						alert("操作成功！");
		   						location.reload();
		   					}else{
...
<body>
    ...
    <div class="top">
        ...
        <div class="t_content"><a href="<%=basePath%>jsp/admin/index.jsp">首页</a>&gt;城市列表</div>
    ...
    <div class="content">
        <div class="c_l"></div>
        <div class="c_c">
            <div class="nav"><a href="<%=basePath%>sys/city_toEdit?city.id=">添加城市</a></div>
            <s:iterator value="citys" var="parent">
                <div class="list">
                    ...
                    <div class="list_r">
                        <a href="<%=basePath%>sys/city_toEdit?city.id=<s:property value="#parent.id" />">修改</a>|
