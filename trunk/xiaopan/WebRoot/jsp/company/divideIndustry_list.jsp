...
<title><s:property value='%{@com.iskyinfo.fw.ssi.common.ConfigReaderUtil@getPropertyValue("app.name.cn")}'/>_企业分类管理</title>
<base href="<%=basePath%>">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		<s:iterator value="infoList">
			data.push(['<s:property value="industryName"/>',<s:property value="count"/>]);
		</s:iterator>
		if(data.length!=0){
...
<body>
	<s:form action="cm_toList" namespace="/company"
		...
		<div class="content_title"><s:property value='%{@com.iskyinfo.fw.ssi.common.ConfigReaderUtil@getPropertyValue("user.label.enter")}'/>分类管理</div>
		<!-- <div id="brDiv"></div> -->
