...
<title><s:property value='%{@com.iskyinfo.fw.ssi.common.ConfigReaderUtil@getPropertyValue("app.name.cn")}'/>_地区整改统计</title>
<base href="<%=basePath%>">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		d1[i] = <s:property value="audited"/>;
		d2[i] = <s:property value="rectify"/>;
		d3[i] = <s:property value="rectified"/>;
		...
		if(d1.length!=0){
			...
			var plot2 = $.jqplot('showPlot',[d1, d2, d3],{
		       title: '地区整改统计',
		       legend: {
		           show: true
		       },
...
<body>
	<s:form action="cm_toHazardStatusList" namespace="/company" id="queryForm">
		<s:hidden name="clazzType" />
		<div class="content_title">地区整改统计</div>
		<!-- <div id="brDiv"></div> -->
		...
		<table width="100%" class="mytable">
			...
			<s:iterator value="infoList">
				<tr onMouseOver="this.className='list_table_hilite'" onMouseOut="this.className=''">
					...
					<td align="center"><s:property value="audited"/>&nbsp;</td>
					<td align="center"><s:property value="rectify"/>&nbsp;</td>
					<td align="center"><s:property value="rectified"/>&nbsp;</td>
				</tr>
			</s:iterator>
		</table>
		</div>
