...
<head>
	...
	<title><s:property value='%{@com.iskyinfo.fw.ssi.common.ConfigReaderUtil@getPropertyValue("app.name.cn")}'/>_企业综合管理</title>
	<base href="<%=basePath%>">
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#clearQuery').click(function(){
				...
				$('#queryForm_org_orgx_superviseGrade_id').val('');
			});
			//查询
...
<div class="content_title"><s:property value='%{@com.iskyinfo.fw.ssi.common.ConfigReaderUtil@getPropertyValue("user.label.enter")}'/>综合管理</div>
<div class="content_list">
	<ul>
	    ...
	    <li>行政区域&nbsp;<s:textfield name="org.regAddr.lovName" /></li>
	    <li>行业类型&nbsp;<s:textfield name="org.industryCat.lovName" /></li>
	    <li>监管等级&nbsp;<s:select list="grades" listKey="id" listValue="lovName" headerKey="" headerValue="--请选择--" name="org.orgx.superviseGrade.id"></s:select> </li>
    </ul>
	...
	<table width="100%" class="mytable">
		...
		<s:iterator value="orgs">
			<tr onMouseOver="this.className='list_table_hilite'" onMouseOut="this.className=''">
				...
				<td align="center"><s:property value="regAddr.lovName"/></td>
				<td align="center"><s:property value="industryCat.lovName"/></td>
