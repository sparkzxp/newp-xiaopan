...
<body>
    ...
    <s:hidden name="city.id"/>
    <div class="top">
        <div class="t_left"></div>
        <div class="t_content"><strong>添加城市</strong></div>
    ...
    <div class="content">
        ...
        <div class="c_c">
            <table border="0" cellpadding="0" cellspacing="0" class="table">
                <tr>
                    <td width="120px" height="25px" align="right">城市名称：</td>
                    <td><s:textfield name="city.name" cssStyle="width:200px;" cssClass="{required:true,maxlengthCN:50}"/></td>
                </tr>
                <tr>
                    <td height="45px"></td>
                    <td>
