			...
			$(".delete").each(function(i) {
				$(this).bind("click", function() {
					if(confirm("确定删除吗？")){
						...
						$.post("<%=basePath%>sys/archive_doDelete",{"archive.id":aid},function(data){
		   					if(data=="success"){
		   						alert("操作成功！");
		   						location.reload();
		   					}else{
...
<body>
	<form id="form1">
		...
		<div class="content">
			...
			<div class="c_c">
				<div class="nav">
					<a href="<%=basePath%>sys/archive_toEdit?archive.id=">添加内容</a>
				</div>
				<table border="0" cellpadding="0" cellspacing="0" class="list_table">
	                ...
	                <s:iterator value="archives" var="parent">
                        <tr class="<s:property value="#parent.id" />">
                            ...
                            <td><s:property value="%{getText('global.datetime',{#parent.senddate})}" /></td>
                            <td>
                                <a href="<%=basePath%>sys/archive_toEdit?archive.id=<s:property value="#parent.id" />">修改</a>
